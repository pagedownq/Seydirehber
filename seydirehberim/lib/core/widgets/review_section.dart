...
class ReviewSection extends ConsumerWidget {
  ...
  void _showAddReview(BuildContext context, WidgetRef ref) async {
    ...
    // Check if double review
    final hasReviewed = await ref.read(reviewServiceProvider).hasUserReviewed(targetId);
        ...
        builder: (context) => Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 12),
              Text(
                'Bu yer/firma için zaten bir değerlendirmeniz bulunmaktadır. Her yer için sadece bir kez yorum yapabilirsiniz.',
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontSize: 15,
                  color: Colors.grey[600],
